...
mixin _$ChatEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int chatId, ChatMessage message, String sockedId)
        sendMessages,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int chatId, ChatMessage message, String sockedId)?
        sendMessages,
...
abstract class _$$SendMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({int chatId, ChatMessage message, String sockedId});
}
    ...
    return _then(_$SendMessage(
      ...
      null == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as ChatMessage,
      sockedId: null == sockedId
          ? _value.sockedId
          : sockedId // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
class _$SendMessage implements SendMessage {
  const _$SendMessage(this.chatId, this.message, {required this.sockedId});
  ...
  @override
  final String sockedId;

  @override
  String toString() {
    return 'ChatEvent.sendMessages(chatId: $chatId, message: $message, sockedId: $sockedId)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.sockedId, sockedId) ||
                other.sockedId == sockedId));
  }

  @override
  int get hashCode => Object.hash(runtimeType, chatId, message, sockedId);
  ...
  TResult when<TResult extends Object?>({
    ...
    return sendMessages(chatId, message, sockedId);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return sendMessages?.call(chatId, message, sockedId);
  }
...
abstract class SendMessage implements ChatEvent {
  const factory SendMessage(final int chatId, final ChatMessage message,
      {required final String sockedId}) = _$SendMessage;
